import {
    Grid, Paper, useTheme, useMediaQuery, TableContainer, Table, TableRow, TableCell, TableHead, TableBody, Button, Box, Typography, Fab, Switch
} from '@mui/material'
...
function Userpage() {
    ...
    let pagePaperStyle;
    if (isMatch){
        pagePaperStyle = { height: 575, marginTop: 1, width: 1065}
    }else{
        pagePaperStyle = { height: 575, marginTop: 1, width: 1065}
    }
